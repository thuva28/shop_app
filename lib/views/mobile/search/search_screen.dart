...
import 'package:shop_app/widgets/mobile/search_shop_list_item_view.dart';
                    ...
                    Expanded(
                      child: TextField(
                        decoration: InputDecoration(
                          hintText: 'Search for shopss and products',
                          hintStyle:
...
class _SearchListView extends StatelessWidget {
  final List<BestTopShop> foods = BestTopShop.getTopGroceryRestaurants();

  @override
  Widget build(BuildContext context) {
    foods.addAll(BestTopShop.getTopGroceryRestaurants());
    foods.shuffle();

    return ListView.builder(
      shrinkWrap: true,
      itemCount: foods.length,
      itemBuilder: (context, index) => SearchShopListItemView(
        food: foods[index],
      ),
    );
  }
